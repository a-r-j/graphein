...
def extract_subgraph_from_backbone(
    ...
    Backbone atoms are defined in :ref:`graphein.rna.constants.RNA_BACKBONE_ATOMS`.
...
def extract_subgraph_from_bases(
    ...
    Backbone atoms are defined in :ref:`graphein.rna.constancts.RNA_BACKBONE_ATOMS`. We exclude these to perform the selection.
...
def extract_subgraph_from_phosphoric_acid(
    ...
    Phosphoric acid atoms are defined in :ref:`graphein.rna.constancts.PHOSPHORIC_ACID_ATOMS`.
...
def extract_subgraph_from_ribose(
    ...
    Ribose atoms are defined in :ref:`graphein.rna.constancts.RIBOSE_ATOMS`.
...
def extract_subgraph_from_residue_types(
    ...
    """Extracts a subgraph from a graph based on a list of allowable (nucleotide) residue types.

    :param g: The graph to extract the subgraph from.
    :type g: nx.Graph
    :param residue_types: List of allowable residue types (1-letter residue names). E.g. ``["A", "G"]``
