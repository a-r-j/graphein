...
ALL_BOND_TYPES_TO_CHANNEL: Dict[Chem.rdchem.BondType, int] = {
    ...
    Chem.rdchem.BondType.FIVEANDHALF: 5,
    Chem.rdchem.BondType.FOURANDHALF: 6,
    Chem.rdchem.BondType.HEXTUPLE: 7,
    Chem.rdchem.BondType.HYDROGEN: 8,
    Chem.rdchem.BondType.IONIC: 9,
    Chem.rdchem.BondType.ONEANDHALF: 10,
    ...
    Chem.rdchem.BondType.THREEANDHALF: 15,
    Chem.rdchem.BondType.THREECENTER: 16,
    Chem.rdchem.BondType.TRIPLE: 17,
    Chem.rdchem.BondType.TWOANDHALF: 18,
...
CHIRAL_TYPE_TO_CHANNEL: Dict[Chem.rdchem.ChiralType, int] = {
    Chem.rdchhem.ChiralType.CHI_OTHER: 0,
    Chem.rdchhem.ChiralType.CHI_TETRAHEDRAL_CCW: 1,
    Chem.rdchhem.ChiralType.CHI_TETRAHEDRAL_CW: 2,
    Chem.rdchhem.ChiralType.CHI_UNSPECIFIED: 3,
}
